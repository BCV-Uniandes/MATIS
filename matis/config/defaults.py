...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "videoswintransformer", "mvitv2"]
...
_C.MODEL.HEAD_DROPOUT_RATE = 0.0
...
# MASKFORMER FEATURES
# ---------------------------------------------------------------------------- #
_C.MASKFORMER = CfgNode()
_C.MASKFORMER.TRANS = False
_C.MASKFORMER.ENABLE = False
_C.MASKFORMER.MOVE_LOSS_WEIGHTS = False
_C.MASKFORMER.FEATURES_TRAIN = ''
_C.MASKFORMER.FEATURES_VAL = ''
